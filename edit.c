...
{
	rtv1->edit_surface = SDL_CreateRGBSurface(0, 640, 480,
		32, 0, 0, 0, 0);
	rtv1->edit_window = SDL_CreateWindow("Properties",
		1800, 200, 640, 480, SDL_WINDOW_SHOWN);
	rtv1->edit_renderer = SDL_CreateRenderer(rtv1->edit_window,
