...
void					edit_mouse_pressed(int button, int x,
							int y, t_rtv1 *rtv1);
void					edit_mouse_release(int button, int x,
							int y, t_rtv1 *rtv1);
void					selector_mouse_pressed(int button, int x,
							int y, t_rtv1 *rtv1);
void					selector_mouse_release(int button, int x,
							int y, t_rtv1 *rtv1);

void					provider(t_rtv1 *rtv1);

double					ray_intersect_obj(t_vector start,
							t_vector dir, t_obj *obj);
double					ray_intersect_paraboloid(t_vector start,
							t_vector dir, t_obj *parab);
double					ray_intersect_triangle(t_vector start,
							t_vector dir, t_obj *triangle);

void					err_exit(void);
int						clean_exit(t_rtv1 *rtv1);

t_vector				rotate_view(t_vector point, double alpha,
							double beta);
...
double					ray_intersect_arrow(t_vector start,
							t_vector dir, t_obj *cyl);
...
void					move_polygonal(double x, double y, double z,
							t_rtv1 *rtv1);
void					rot_polygonal(double x, double y, double z,
							t_rtv1 *rtv1);
